       ...
       <div class="row row-cols-1 row-cols-lg-4 g-4">
        <div class="col">
          <div class="footer-widget-6">
            <img src="assets-user/images/logo.webp" class="logo-img mb-3" alt="">
       ...
       <div class="row">
         <div class="col-12">
          ...
          <div class="app-icon d-flex flex-column flex-sm-row align-items-center justify-content-center gap-2">
            <div>
              <a href="javascript:;">
                <img src="assets-user/images/play-store.webp" width="160" alt="">
              </a>
            </div>
            <div>
              <a href="javascript:;">
                <img src="assets-user/images/apple-store.webp" width="160" alt="">
              </a>
            </div>
          </div>
         </div>
