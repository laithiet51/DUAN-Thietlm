       ...
       <form action="index.php?act=address" method="post">
        ...
        <div class="card-body">
          ...
          <input class="form-check-input" type="checkbox" value ="'.$id.'" name="idspf[]">
                ...
                <div class="h6 fw-bold">$'.$pricesale.'</div>
           ...
           <div class="d-grid gap-2 align-self-start align-self-lg-center">
              <a href="index.php?act=delcart&idcart='.$id.'"  class="btn btn-ecomm"><i class="bi bi-x-lg me-2"></i>Delete</a>
              <a href=""><button type="button" class="btn dark btn-ecomm"><i class="bi bi-suit-heart me-2"></i>Move to Wishlist</button></a>
           </div>
			  	</div>
			  </div>
        </div>
      ...
      <div class="card-body">
       ...
       <div class="hstack align-items-center justify-content-between fw-bold text-content">
        ...
        <div class="d-grid mt-4">
           ...
           <input type="submit" name="order" class="btn btn-dark btn-ecomm py-3 px-5"><a href="index.php?act=address" style="color: aliceblue;" >Place Order</a>
        </div>
      </div>
    </div>
